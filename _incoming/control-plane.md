...
Where producers, routing, pipelines, personas, ingresses, egresses, directives, and budgets are
defined and changed — and how the person operating the machine actually works with it day to day.
...
- Everything that shapes behaviour is configuration, not buried logic: producers, routing rules,
  pipeline registration, ingress and egress definitions, persona definitions, directives, model
  assignments, budgets.
...
- The daily operating surface covers three things — the exhaust and its decisions, runs waiting
  at a gate, and an item's lineage when something looks wrong. These are the screens that matter.
